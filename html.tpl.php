		...
		<div id="page">
			...
			<div id="container">                      
				<div class="container-content">
					...
					<div id="container-left" class="column column-left" style="display: none;">
						
					</div>
					<?php include(BASE_PATH.DIRECTORY_SEPARATOR."content".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."highscope".DIRECTORY_SEPARATOR."sidebar.tpl.php"); ?>
